<?php
class Pandamp_Image_GD extends Pandamp_Image_Abstract 
{
	...
	public function flip($newFile, $mode)
	{
		...
		switch ($mode){
			case Pandamp_Image_Abstract::FLIP_VERTICAL:
            	$srcY 	   = $this->_height - 1;
            	$srcHeight = -$this->_height;
        		break;
			case Pandamp_Image_Abstract::FLIP_HORIZONTAL:
				$srcX	  = $this->_width - 1;
				$srcWidth = -$this->_width;
				break;
			default:
...
//				imagecopymerge($source, $overlay, $this->_width - $overlayWidth, 0, 0, 0, $overlayWidth, $overlayHeight, $opacity);
				break;
			case Pandamp_Image_Abstract::POS_BOTTOM_LEFT:
				imagecopy($source, $overlay, 0, $this->_height - $overlayHeight, 0, 0, $overlayWidth, $overlayHeight);
				break;
			case Pandamp_Image_Abstract::POS_BOTTOM_RIGHT:
