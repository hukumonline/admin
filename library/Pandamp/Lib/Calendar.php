...
class Pandamp_Lib_Calendar
{
    ...
    function getDayNameHeader($month, $year)
    {
            ...
            //$s .= "<tr><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/year/" . $pyear." onclick=\"$('#showDiv1').load($(this).attr('href'));return false;\" class='headerNav' title='Prev Year'><<</a></th><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/month/" . $prevmonth . "/year/" . $prevyear." onclick=\"$('#showDiv1').load($(this).attr('href'));return false;\" class='headerNav' title='Prev Month'><</a></th>";
            $s .= "<tr><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/year/" . $pyear." onclick=\"hcl($(this).attr('href'));return false;\" class='headerNav' title='Prev Year'><<</a></th><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/month/" . $prevmonth . "/year/" . $prevyear." onclick=\"hcl($(this).attr('href'));return false;\" class='headerNav' title='Prev Month'><</a></th>";
            $s .= "<th colspan='3' class=\"header\">$month $year</th>";
            //$s .= "<th class='header'><a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/month/" . $nextmonth . "/year/" . $nextyear." onclick=\"$('#showDiv1').load($(this).attr('href'));return false;\" class='headerNav' title='Next Month'>></a>&nbsp;</th><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/year/" . $nyear." onclick=\"$('#showDiv1').load($(this).attr('href'));return false;\" class='headerNav' title='Next Year'>>></a></th></tr><tr>\n";
            $s .= "<th class='header'><a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/month/" . $nextmonth . "/year/" . $nextyear." onclick=\"hcl($(this).attr('href'));return false;\" class='headerNav' title='Next Month'>></a>&nbsp;</th><th class='header'>&nbsp;<a href=".ROOT_URL."/".$zl->getLanguage()."/agenda/year/" . $nyear." onclick=\"hcl($(this).attr('href'));return false;\" class='headerNav' title='Next Year'>>></a></th></tr><tr>\n";
...
//						$str .= "<span class=\"title_txt\">-";
						$str .= "<a href=\"".ROOT_URL."/".$zl->getLanguage()."/calendar/event/openposting/pid/" . $eventdata[$day]["id"][$j] . "\" class=\"ecal\">";
