...
class App_Model_Db_Table_Row_Folder extends Zend_Db_Table_Row_Abstract
{
    ...
    {
        return $this->findDependentRowset('App_Model_Db_Table_CatalogFolder');
    }
